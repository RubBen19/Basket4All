...
class Shots2 {
    private var cornerL = Pair(0, 0) //Desde la esquina izquierda(Acertados, fallados)
    private var cornerR = Pair(0, 0) //Desde la esquina derecha(Acertados, fallados)
    private var fortyFiveL = Pair(0, 0) //Desde la 45º izquierda(Acertados, fallados)
    private var fortyFiveR = Pair(0, 0) //Desde la 45º derecha(Acertados, fallados)
    private var center = Pair(0, 0) //Desde el centro(Acertados, fallados)
    private var total = Pair(0, 0) //Totales(Acertados, fallados)
    ...
    fun getCornerRightPoints(): Int {
        return cornerR.first * 2
    }
    //Obtener puntos fallados
    fun getCornerRightPointsFailed(): Int {
        return cornerR.second * 2
    }
    //Acierto
    ...
    fun get45LeftPoints(): Int {
        return fortyFiveL.first * 2
    }
    //Obtener puntos fallados
    fun get45LeftPointsFailed(): Int {
        return fortyFiveL.second * 2
    }
    //Acierto
    fun ffLeftPoint() {
    ...
    fun get45RightPoints(): Int {
        return fortyFiveR.first * 2
    }
    //Obtener puntos fallados
    fun get45RightPointsFailed(): Int {
        return fortyFiveR.second * 2
    }
    //Acierto
    fun ffRightPoint() {
